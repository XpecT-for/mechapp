    ...
    if (currentPage == 1) {
      return (
        <React.Fragment>
          <button
            className="element"
            onClick={() => this.serviceTypeFunc("Diagnose and Repair")}
          >
            <i className="fa fa-wrench" aria-hidden="true"></i>Diagnose and
            Repair
          </button>
          <button
            className="element"
            onClick={() => this.serviceTypeFunc("Tyre Service")}
          >
            <i className="fa fa-circle-o" aria-hidden="true"></i>Tyre Service
          </button>
          <button
            className="element"
            onClick={() => this.serviceTypeFunc("Jump Start")}
          >
            <i className="fa fa-battery-quarter" aria-hidden="true"></i>Jump
            Start
          </button>
          <button
            className="element"
            onClick={() => this.serviceTypeFunc("Locksmith Service")}
          >
            <i className="fa fa-unlock-alt" aria-hidden="true"></i>Locksmith
            Service
          </button>
        </React.Fragment>
      );
    ...
    if (currentPage == 3) {
      return (
        <React.Fragment>
          ...
          <button
            className="element"
            onClick={() => this.locationFunc("Custom")}
          >
            Custom
          </button>
        </React.Fragment>
