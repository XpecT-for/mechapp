    ...
    if (currentPage == 1) {
      return (
        <React.Fragment>
          <button
            className="element"
            onClick={() => this.serviceTypeFunc("Diagnose ")}
          >
            <i className="fa fa-wrench" aria-hidden="true"></i>Diagnose
          </button>
          <button
            className="element"
            onClick={() => this.serviceTypeFunc("Tyre Check")}
          >
            <i className="fa fa-circle-o" aria-hidden="true"></i>Tyre Check
          </button>
          <button
            className="element"
            onClick={() => this.serviceTypeFunc("Battery Check")}
          >
            <i className="fa fa-battery-quarter" aria-hidden="true"></i>Battery
            Check
          </button>
          <button
            className="element"
            onClick={() => this.serviceTypeFunc("Oil Check")}
          >
            <i className="fa fa-tint" aria-hidden="true"></i>Oil Check
          </button>
        </React.Fragment>
      );
    }
